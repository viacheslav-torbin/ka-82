...
Picture::Picture()
{
	...
	this->x = 0;
	this->y = 0;
	cout << "Я конструктор Picture" << endl;
}
...
Picture::~Picture()
{
	cout << "Я deструктор Picture" << endl;
}
