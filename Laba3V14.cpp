...
Creature::Creature()
{
	cout << "я конструктор Creature" << endl;
	this->LifeStatus = 1;
}
...
Creature::~Creature()
{
	cout << "я деконструктор Creature" << endl;
}
...
Plant::~Plant()
{
	cout << "я деконструктор Plant" << endl;
}
...
{
	cout << "я конструктор UnMovedObject" << endl;
}
...
UnMovedObject::~UnMovedObject()
{
	cout << "я деконструктор UnMovedObject" << endl;
}
...
Herbivorous::Herbivorous()
{
	...
	cout << "я конструктор Herbivorous" << endl;
}
...
Herbivorous::~Herbivorous()
{
	cout << "я деструктор Herbivorous" << endl;
}
...
Predator::Predator()
{
	...
	cout << "я конструктор Predator" << endl;
}
...
Predator::~Predator()
{
	cout << "я деструктор Predator" << endl;
}
